...
public class Zombie3 {
   ...
   public Zombie3 (JPanel p, Player player) {
      panel = p;
      ...
      soundManager = SoundManager.getInstance();
        ...
        animations.put(State.IDLE, new StripAnimation("zombie3/Idle.png", 8, true));
		animations.put(State.WALK, new StripAnimation("zombie3/Walk.png", 8, true));
		animations.put(State.ATTACK, new StripAnimation("zombie3/Attack_1.png", 5, true));
		animations.put(State.DEAD, new StripAnimation("zombie3/Dead.png", 5, false));
