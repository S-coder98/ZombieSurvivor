...
public class Zombie2 {
   ...
   public Zombie2 (JPanel p, Player player) {
      panel = p;
      ...
      soundManager = SoundManager.getInstance();
        ...
        animations.put(State.IDLE, new StripAnimation("zombie2/Idle.png", 5, true));
		animations.put(State.WALK, new StripAnimation("zombie2/Walk.png", 7, true));
		animations.put(State.ATTACK, new StripAnimation("zombie2/Attack_1.png", 4, true));
		animations.put(State.DEAD, new StripAnimation("zombie2/Dead.png", 5, false));
